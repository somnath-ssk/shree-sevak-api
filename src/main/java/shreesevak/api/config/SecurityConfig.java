...
//    	"/api/role/**","/api/user/**","/api/member/**","/api/baithak/**","/api/location/**","/api/schedular/**",
    	http.csrf(csrf->csrf.disable()).cors(corp->corp.disable()).authorizeHttpRequests(auth->auth
    			.requestMatchers("/auth/login","/api/user/**","/api/baithak/**","/api/register/**","/api/area/**","/api/country/**","/api/schedular/**","/api/location/**","/api/member/**","/api/week/**","/api/baithak2/**","/api/people/**")
