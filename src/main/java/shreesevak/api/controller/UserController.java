...
public class UserController {
	...
	// PUT -update user
	@PutMapping("/{userId}")
	public ResponseEntity<UserDto> updateUser(@RequestBody UserFrontEndData userFrontEndData,
	...
	public ResponseEntity<PaginationResponse> searchUserbaseOnField(
			@RequestParam(value = "keyword", required = false) String keyword,
			@RequestParam(value = "status", required = false) String status,
			@RequestParam("pageNumber") int pageNumber,
			@RequestParam("pageSize") int pageSize) {

		return ResponseEntity.ok(this.userService.searchUsers(keyword, status, pageNumber, pageSize));
	}
...
//		throw new ResourceNotFoundException("Email is not prsent in Databse", "not found", email);
		...
		String message = "Your One-Time Password (OTP) for Shree Seva Account is-  " + otp + "<br><br>"
				+ "Please use this OTP to complete the verification process.<br>";
		String to = email;
...
//	    }
	...
	public String changePassword(@RequestParam("confirmPassword") String confirmPassword, HttpSession session) {
		...
		String message = "Dear " + user.getName() + ",<br><br>Congratulations!" + " You've successfully updated"
